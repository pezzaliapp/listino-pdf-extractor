// In-app user manual content and modal renderer (v4 — minimal).
  ...
  <div class="manual-layout">
    ...
    <div class="manual-content">
      ...
      <section id="m-1">
        ...
        <p>Legge un PDF di listino e produce un Excel con 4 colonne: <strong>Codice, Descrizione, Prezzo, Pagina</strong>. Punto.</p>
      </section>
      ...
      <section id="m-4">
        ...
        <ul>
          ...
          <li><code>CHECK</code> = il parser non è riuscito a determinare il prezzo (o un altro dato critico). <strong>Apri il PDF originale alla pagina indicata e correggi a mano.</strong></li>
